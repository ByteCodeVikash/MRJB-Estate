...
export default function AboutSection() {
  return (
    <section id="about" className="py-24 bg-white relative overflow-hidden scroll-mt-24">
      ...
      <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#D4AF37]/5 rounded-tr-full -z-0 opacity-50" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-[#1C1C1C] font-bold">About Kunj Bihari Enclave Phase 1</h2>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            ...
            <blockquote className="pl-6 border-l-4 border-[#D4AF37] text-xl font-serif italic text-[#1C1C1C]">
          ...
          >
            {siteData.stats.map((stat, idx) => (
              <div key={idx} className="bg-white p-6 border border-gray-100 shadow-lg rounded-lg hover:border-[#D4AF37] transition-colors group">
                ...
                <h3 className="text-[#1C1C1C] font-bold text-xl mb-1">{stat.title}</h3>
