  ...
  return (
    <section id="home" className="relative h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6 text-center pt-20">
        ...
        >
          <motion.span variants={itemVariants} className="text-[#D4AF37] font-semibold tracking-[0.2em] text-sm md:text-base uppercase mb-4">
            MRJB Group Presents
          </motion.span>
          
          <motion.h1 variants={itemVariants} className="font-serif text-5xl md:text-7xl lg:text-8xl text-white font-bold leading-tight mb-2">
            Kunj Bihari Enclave
          </motion.h1>
          
          <motion.div variants={itemVariants} className="font-serif italic text-3xl md:text-4xl text-[#D4AF37] mb-6">
            Phase 1
          </motion.div>

          <motion.div variants={itemVariants} className="w-24 h-px bg-[#D4AF37] mb-8" />

          <motion.p variants={itemVariants} className="text-xl md:text-2xl text-white/90 font-light mb-2">
            Premium Residential Plots Near Vrindavan
          </motion.p>
          
          <motion.p variants={itemVariants} className="text-lg text-[#D4AF37]/80 mb-10 tracking-wide uppercase">
